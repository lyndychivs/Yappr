...
public sealed class TldrOrchestratorTests
{
    ...
    public async Task RunAsync_InvalidWindow_ReturnsFailureWithoutFetchingOrSummarizing()
    {
        ...
        var orchestrator = new TldrOrchestrator(messageFetcher.Object, summarizer.Object, this.limits);
    ...
    {
        var messageFetcher = new Mock<IMessageFetcher>(MockBehavior.Loose);
        messageFetcher
    ...
    public async Task RunAsync_MessagesFound_ReturnsSummaryFromSummarizer()
    {
        ...
        var summarizer = new Mock<ISummarizer>(MockBehavior.Loose);
        summarizer
